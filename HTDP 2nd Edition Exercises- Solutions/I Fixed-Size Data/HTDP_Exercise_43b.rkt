...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname HTDP_Exercise_43b) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; Exercise 43 Second Question (move the car according to a sine wave)
;; This solutions is not correct. Instead of sine function, I just used
...
(define (render as)
  (place-image CAR as (remainder as 60) BACKGROUND))
(check-expect (render 10)
              (place-image CAR 10 (remainder 10 60) BACKGROUND))
(check-expect (render 100)
              (place-image CAR 100 (remainder 100 60) BACKGROUND))
